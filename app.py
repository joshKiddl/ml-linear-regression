...
def featureName():
    ...
    prompt_string = "Based on the user story, target customer, and solution hypothesis, provide me a list of potential Feature Names for this feature (keep them within 200 characters. seperate them with '/b'): "
    problem_statement = prompt_string + " " + input_text
    response = openai.Completion.create(
        model="text-davinci-002",
        prompt=problem_statement,
